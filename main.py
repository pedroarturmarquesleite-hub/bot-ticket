...
def set_sales_role_id(guild_id, role_id):
    _set_guild_setting(guild_id, "sales_role_id", _id_int(role_id))


def get_sales_role_id(guild_id):
...
def set_sales_log_channel_id(guild_id, channel_id):
    _set_guild_setting(guild_id, "sales_log_channel_id", _id_int(channel_id))


def get_sales_log_channel_id(guild_id):
    return _id_int(_get_guild_setting(guild_id, "sales_log_channel_id"))


def get_sales_log_channel(guild):
    if guild is None:
        return None
    channel_id = get_sales_log_channel_id(guild.id)
